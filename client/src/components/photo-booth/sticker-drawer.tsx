...
export function StickerDrawer({
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <div className="fixed inset-x-0 bottom-0 z-50 bg-card border-t border-border rounded-t-2xl shadow-2xl max-h-[70vh] md:max-h-[50vh] lg:max-h-[40vh] flex flex-col animate-slide-up">
        {/* Header */}
